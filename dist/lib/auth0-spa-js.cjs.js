...
var Auth0Client = /** @class */ (function () {
    ...
    Auth0Client.prototype.getUser = function (options) {
        if (options === void 0) { options = {}; }
        var audience = options.audience || this.options.audience || 'default';
        var scope = getUniqueScopes(this.defaultScope, this.scope, options.scope);
        var cache = this.cache.get(new CacheKey({
            client_id: this.options.client_id,
            audience: audience,
            scope: scope
        }));
    ...
    Object.defineProperty(Auth0Client.prototype, "isAuthenticated", {
        /**
         * ```js
