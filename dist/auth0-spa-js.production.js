!(function (e, t) {
  ...
  var ce,
    ...
    pe = Math.min,
    he = function (e) {
      return e > 0 ? pe(Ie(e), 9007199254740991) : 0;
    },
    ye = Math.max,
    be = Math.min,
    me = function (e) {
    ...
    Te = D('wks'),
    Ee = l.Symbol,
    Ne = Le ? Ee : (Ee && Ee.withoutSetter) || P,
    Ye = function (e) {
      return (
        Z(Te, e) ||
          (ke && Z(Ee, e) ? (Te[e] = Ee[e]) : (Te[e] = Ne('Symbol.' + e))),
        Te[e]
      );
    },
    Ke = Ye('match'),
    ...
    Me = De('startsWith'),
    qe = !(
      Me || ((ce = je(String.prototype, 'startsWith')), !ce || ce.writable)
    );
  He(
    { target: 'String', proto: !0, forced: !qe && !Me },
    {
      startsWith: function (e) {
        var t = String(C(this));
        Oe(e);
        var n = he(Pe(arguments.length > 1 ? arguments[1] : void 0, t.length)),
          i = String(e);
      ...
      concat: function (e) {
        ...
        for (t = -1, i = arguments.length; t < i; t++)
          if (Ct((o = -1 === t ? c : arguments[t]))) {
            if (a + (r = he(o.length)) > yt) throw TypeError(bt);
        ...
        Z(un, i)
          ? (n.enumerable
              ? (Z(e, Pt) && e[Pt][i] && (e[Pt][i] = !1),
                (n = Wt(n, { enumerable: h(0, !1) })))
              : (Z(e, Pt) || cn(e, Pt, h(1, {})), (e[Pt][i] = !0)),
            hn(e, i, n))
          : cn(e, i, n)
      );
    },
  ...
  if (
    (ke ||
      (ae(
        (nn = function () {
          ...
          return g && pn && hn(tn, t, { configurable: !0, set: n }), yn(t, e);
        }).prototype,
        'toString',
        function () {
          return en(this).tag;
    ...
    He(
      ...
      { getOwnPropertyNames: Fn, getOwnPropertySymbols: Sn }
    ),
    He(
      {
        target: 'Object',
  ...
  if (
    ...
    we(Xn, Vn);
    var Gn = (Xn.prototype = Vn.prototype);
    Gn.constructor = Xn;
    var xn = Gn.toString,
  ...
  [].keys &&
    ('next' in (Wn = [].keys())
      ? (Jn = Nn(Nn(Wn))) !== Object.prototype && (Qn = Jn)
      : (Kn = !0)),
    null == Qn && (Qn = {}),
    Z(Qn, Yn) ||
      W(Qn, Yn, function () {
  ...
  var On = { IteratorPrototype: Qn, BUGGY_SAFARI_ITERATORS: Kn },
    ...
    ii = function (e, t, n, i, r, o, c) {
      !(function (e, t, n) {
        var i = t + ' Iterator';
        (e.prototype = Wt(Dn, { next: h(1, n) })), zt(e, i, !1), (zn[i] = jn);
      })(n, t, i);
      var s,
        a,
        u,
      ...
      if (
        ...
        if (((a = { values: l(ei), keys: o ? p : l($n), entries: l(ti) }), c))
  ...
  if (
    (!Qi || 'function' != typeof wi || wi === Function.prototype) &&
    ((wi = function () {
      throw TypeError('Incorrect invocation');
    }),
    Qi)
  )
    for (Ci in Ji) l[Ci] && _n(l[Ci], wi);
  if ((!Qi || !Xi || Xi === Gi) && ((Xi = wi.prototype), Qi))
    for (Ci in Ji) l[Ci] && _n(l[Ci].prototype, Xi);
  if ((Qi && Nn(Vi) !== Xi && _n(Vi, Xi), g && !Z(Xi, Ai)))
    for (Ci in (!0,
    Fi(Xi, Ai, {
      get: function () {
    ...
    Mi = (function (e, t) {
      ...
      return (ji[e] =
        ...
        !d(function () {
          if (i && !g) return !0;
          var e = { length: -1 };
          i ? Di(e, 1, { enumerable: !0, get: _i }) : (e[1] = 1),
            n.call(e, r, o);
        }));
      ...
      if (g) i = e;
        ...
        if (gi(r)) {
          for (o = 0, c = he(e.length); c > o; o++)
            if ((s = h(e[o])) && s instanceof er) return s;
          return new er(!1);
        }
        i = r.call(e);
      }
      ...
      ? ((e._handled = !0),
        Zr._immediateFn(function () {
          ...
          if (null !== n) {
            ...
            wr(t.promise, i);
          } else (1 === e._state ? wr : Xr)(t.promise, e._value);
        }))
      : e._deferreds.push(t);
  }
  function wr(e, t) {
    try {
      ...
      if (t && ('object' == typeof t || 'function' == typeof t)) {
        var n = t.then;
        if (t instanceof Zr) return (e._state = 3), (e._value = t), void Gr(e);
  ...
  (Zr.prototype.catch = function (e) {
    ...
    (Zr.all = function (e) {
      return new Zr(function (t, n) {
        if (!Sr(e)) return n(new TypeError('Promise.all accepts an array'));
        var i = Array.prototype.slice.call(e);
        if (0 === i.length) return t([]);
        var r = i.length;
        function o(e, c) {
    ...
    (Zr.race = function (e) {
      return new Zr(function (t, n) {
        if (!Sr(e)) return n(new TypeError('Promise.race accepts an array'));
  ...
  var Jr = s(
    ...
    Lr = { name: 'auth0-spa-js', version: '1.13.5' },
    Tr = (function (e) {
      function n(t, i) {
      ...
      return new Promise(function (e, n) {
        var i,
          r = setTimeout(function () {
            n(new Yr(o)), window.removeEventListener('message', i, !1);
      ...
      return o(this, function (o) {
        switch (o.label) {
          ...
          case 1:
            ...
            o.label = 2;
          case 2:
            return o.trys.push([2, 4, , 5]), [4, to(e, n, c, s, a, t)];
          case 3:
  ...
  var io = function (e) {
    ...
    ro = function () {
      ...
      return io(e.join(' ').trim().split(/\s+/)).join(' ');
    };
  function oo(e, t) {
    var n = e.baseUrl,
      c = e.timeout,
  ...
  var co = (function () {
    ...
    Io = (function () {
      function e(e) {
        (this.storage = e), (this.transaction = this.storage.get(fo));
      }
      return (
        (e.prototype.create = function (e) {
          (this.transaction = e),
            this.storage.save(fo, e, { daysUntilExpire: 1 });
        }),
        (e.prototype.get = function () {
          return this.transaction;
        }),
        (e.prototype.remove = function () {
          delete this.transaction, this.storage.remove(fo);
        }),
        e
      );
    })(),
    ...
    yo = function (e) {
      ...
      if (e.max_age && !po(t.claims.auth_time))
        throw new Error(
  ...
  var mo = bo.get,
    ...
    Fo = {
      get: function (e) {
        var t = Bo.get(e);
        return t || Bo.get('_legacy_' + e);
      },
      save: function (e, t, n) {
        var i = {};
        'https:' === window.location.protocol && (i = { secure: !0 }),
          (i.expires = n.daysUntilExpire),
          vo('_legacy_' + e, JSON.stringify(t), i),
          Bo.save(e, t, n);
      },
      remove: function (e) {
        Bo.remove(e), Bo.remove('_legacy_' + e);
      }
    },
    So = {
      get: function (e) {
  ...
  var Zo,
    ...
    Go =
      ...
      (wo = !1),
      function (e) {
        return (Xo = Xo || Uo(Zo, Vo, wo)), new Worker(Xo, e);
      }),
    xo = {},
    Ao = new Jr(),
    Ro = 'auth0.lock.getTokenSilently',
    Qo = {
      memory: function () {
        return new go().enclosedCache;
      },
    ...
    Ho = (function () {
      function e(e) {
        ...
        if (
          ...
          (this.cookieStorage = !1 === e.legacySameSiteCookie ? Bo : Fo),
          (this.sessionCheckExpiryDays = e.sessionCheckExpiryDays || 1),
          !Jo(this.cacheLocation))
        )
          throw new Error(
        ...
        var r,
          o,
          c = e.useCookiesForTransactions ? this.cookieStorage : So;
        (this.cache = Jo(this.cacheLocation)()),
          (this.scope = this.options.scope),
          (this.transactionManager = new Io(c)),
          ...
          this.options.useRefreshTokens &&
            (this.scope = ro(this.scope, 'offline_access')),
          'undefined' != typeof window &&
            window.Worker &&
            this.options.useRefreshTokens &&
      ...
      return (
        ...
        (e.prototype._getParams = function (e, t, r, o, c) {
          ...
          return n(n(n({}, a), e), {
            scope: ro(this.defaultScope, this.scope, e.scope),
            response_type: 'code',
            response_mode: 'query',
            state: t,
            nonce: r,
        ...
        (e.prototype.getUser = function (e) {
          void 0 === e && (e = {});
          var t = e.audience || this.options.audience || 'default',
            n = ro(this.defaultScope, this.scope, e.scope),
            i = this.cache.get(
              new co({
                client_id: this.options.client_id,
                audience: t,
          ...
          return i && i.decodedToken && i.decodedToken.user;
        }),
        (e.prototype.getIdTokenClaims = function (e) {
          ...
          return i && i.decodedToken && i.decodedToken.claims;
        }),
                ...
                switch (i.label) {
                  case 0:
                    return (
                      ...
                      (e.scope = ro(this.defaultScope, this.scope, e.scope)),
                      (t = n(n({}, Wr), t)),
        ...
        Object.defineProperty(e.prototype, 'isAuthenticated', {
          get: function () {
            return !!this.getUser();
          },
          enumerable: !1,
        ...
        (e.prototype._getTokenFromIFrame = function (e) {
          return r(this, void 0, void 0, function () {
            ...
            return o(this, function (o) {
              switch (o.label) {
                case 0:
                  return (t = _r(jr())), (r = _r(jr())), (c = jr()), [4, Mr(c)];
                case 1:
                  (s = o.sent()),
                    (a = $r(s)),
                    (u = this._getParams(
  ...
  function ko(e) {
    return r(this, void 0, void 0, function () {
      ...
      return o(this, function (n) {
        switch (n.label) {
          case 0:
            return [4, (t = new Ho(e)).checkSession()];
          case 1:
            return n.sent(), [2, t];
        }
      });
  ...
  var Lo = ko;
  return (Lo.Auth0Client = Ho), (Lo.createAuth0Client = ko), Lo;
}),
  'Auth0Client' in this &&
    this.console &&
    this.console.warn &&
